...
class Master:
    ...
    def hyperband(self, max_iter=81, eta=3, resource="epochs", timing_filename="hyperband_timing.txt"):
        ...
        for irun in range(7, 10):
            ...
            self.write_new_line(timing_filename, "Hyperband total time: {}".format(total_time))
    ...
    def main(self, nb_workers=2):
        ...
        self.hyperband(max_iter=60, eta=3, resource="time")
